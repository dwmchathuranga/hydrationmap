...
import numpy as np
import copy
x = 2000  # remove noise level, change 200000
...
def get_data():
    ...
    j = 0
    t = []
    for i in ["C:\\Bruker\\TopSpin4.0.6\\examdata\\DNP-AF3Days\\30\\pdata\\8",
              "C:\\Bruker\\TopSpin4.0.6\\examdata\\DNP-AF3Days\\28\\pdata\\6",
              "C:\\Bruker\\TopSpin4.0.6\\examdata\\DNP-AF3Days\\30\\pdata\\8",
              "C:\\Bruker\\TopSpin4.0.6\\examdata\\DNP-AF3Days\\28\\pdata\\6",
              "C:\\Bruker\\TopSpin4.0.6\\examdata\\DNP-AF3Days\\30\\pdata\\8",
              "C:\\Bruker\\TopSpin4.0.6\\examdata\\DNP-AF3Days\\28\\pdata\\6"
              ]:
        dic, data = nmrglue.fileio.bruker.read_pdata(dir=i, bin_files=None, procs_files=None, read_procs=True,
                                                     acqus_files=None, read_acqus=True, scale_data=True, shape=None,
                                                     submatrix_shape=None, all_components=False, big=None, isfloat=None)
        if j % 2 == 0:
            t = []
            t.append(data)
        else:
